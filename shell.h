...
/**
 * struct InfoNode - it contains simulated arguments for a function pointer,
 *					 allowing for a consistent function prototype
 * @arg: a string generated from getline that holds the  arguments
 * @argv: it is an array of strings generated from @arg
 * @path: shows the path string for the current command
 * @argc: shows the number of arguments
 * @lines: shows the number of errors encountered
 * @error_code: it is the exit() error code
 * @lc_flag: a flag indicating whether this line of input should be counted
 * @prog_name: tells the name of the program's file
